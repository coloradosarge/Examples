...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\publisher\security"
arrKeyPath2(x) = "x"
...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\common\toolbars\publisher"
arrKeyPath2(x) = "x"
...
x = x + 1
arrFinding(x) = "DTOO322"
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\publisher"
arrKeyPath2(x) = "x"
arrSubKey(x) = "PromptForBadFiles"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
arrExpectedValue(x) = "0"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Prompt files to open instead of blocking"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "DTOO323"
arrKeyPath(x) = "Software\Policies\Microsoft\Office\Common\Security"
arrKeyPath2(x) = "x"
arrSubKey(x) = "AutomationSecurityPublisher"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
arrExpectedValue(x) = "3"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Publisher Automation Security Level"
arrCategory(x) = "II"

WScript.Echo "Performing " & x & " security checks on Microsoft Office 2010 Publisher" & vbCrLf
