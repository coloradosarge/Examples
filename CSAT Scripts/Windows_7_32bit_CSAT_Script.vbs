...
Const FW_IPV6_PROTOCOL = 41
Const FW_UDP_PROTOCOL = 17
Const FW_ACTION_BLOCK = 0
Const FW_ACTION_ALLOW = 1
Const FW_PROFILE_DOMAIN = 1
Const FW_PROFILE_PRIVATE = 2
Const FW_PROFILE_PUBLIC = 4
Const FW_PROFILE_ALL = 7
Const FW_DIR_IN = 1
Const FW_DIR_OUT = 2
...
arrExpectedValue2(x) = "7601"
arrExpectedValue3(x) = "0"
arrType(x) = "OS_Version"
arrTitle(x) = "Approved Service Packs"
arrCategory(x) = "I"

x = x + 1
arrFinding(x) = "V-1074"
arrKeyPath(x) = "SOFTWARE\Symantec\Symantec Endpoint Protection\AV"
arrSubKey(x) = "SOFTWARE\McAfee\AVEngine"
...
arrFile3(x) = "0"
arrHive(x) = HKLM
arrExpectedValue(x) = "Symantec AntiVirus"
arrExpectedValue2(x) = "McShield"
arrExpectedValue3(x) = "SepMasterService"
arrType(x) = "Antivirus"
...
arrExpectedValue3(x) = "0"
arrType(x) = "LogPerms"
arrTitle(x) = "ACLs for Event Logs"
arrCategory(x) = "II"
...
x = x + 1
arrFinding(x) = "V-1084"
arrKeyPath(x) = "System\CurrentControlSet\Control\Session Manager\Memory Management"
arrSubKey(x) = "ClearPageFileAtShutdown"
arrSubKey2(x) = "x"
arrSubkey3(x) = "x"
arrFile1(x) = "0"
arrFile2(x) = "0"
...
arrExpectedValue3(x) = "0"
arrType(x) = "String"
arrTitle(x) = "Floppy Media on Logon"
arrCategory(x) = "III"
...
arrExpectedValue3(x) = "0"
arrType(x) = "RegAudit"
arrTitle(x) = "Regitry Key Auditing"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "Value"
arrTitle(x) = "Halt on Audit Failure"
arrCategory(x) = "III"
...
arrExpectedValue3(x) = "0"
arrType(x) = "SeceditRegExp"
arrTitle(x) = "Disable Built-in Guest Account"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "RenameUser"
arrTitle(x) = "Rename Built-in Administrator Account"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ManualReview"
arrTitle(x) = "Users with Administrative Privilege"
arrCategory(x) = "II"
...
arrExpectedValue2(x) = "0"
arrExpectedValue3(x) = "0"
arrType(x) = "LocalAccounts"
arrTitle(x) = "Local Users Exist on a Workstation"
arrCategory(x) = "III"
...
arrExpectedValue3(x) = "0"
arrType(x) = "Value"
arrTitle(x) = "CtrlAltDel Security Attention Sequence"
arrCategory(x) = "II"
...
arrTitle(x) = "Remotely Accessible Registry Paths"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Remote Assistance - Solicit Remote Assistance"
arrCategory(x) = "I"
...
arrFile3(x) = "0"
arrHive(x) = HKLM
arrExpectedValue(x) = ".*W3SVC.*"
arrExpectedValue2(x) = "Disabled"
arrExpectedValue3(x) = "0"
arrType(x) = "ServiceDisabled"
arrTitle(x) = "Internet Information System Installed"
arrCategory(x) = "I"
...
arrExpectedValue3(x) = "0"
arrType(x) = "Value"
arrTitle(x) = "Domain Controller Authentication for Unlock"
arrCategory(x) = "III"
...
arrExpectedValue3(x) = "0"
arrType(x) = "Value"
arrTitle(x) = "Storage of Passwords and Credentials"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "Value"
arrTitle(x) = "Session Security for NTLM SSP Based Client"
arrCategory(x) = "II"
...
arrTitle(x) = "TS/RDS - Time Limit for Disc. Session"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Error Reporting - Report Errors"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "SMB Client Packet Signing (Always)"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ManualReview"
arrTitle(x) = "Administrator Account Password Changes"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "UAC - Non UAC Compliant App. Virtualization"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "RS/RDS - Prevent Password Saving"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V-14248"
arrKeyPath(x) = "Software\Policies\Microsoft\Windows NT\Terminal Services"
arrSubKey(x) = "fDenyTSConnections"
arrSubKey2(x) = "X"
arrSubkey3(x) = "X"
arrFile1(x) = "0"
arrFile2(x) = "0"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "RS/RDS - Remote User Connections"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "RPC - Unauthenitcated RPC Clients"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "RPC - Endpont Mapper Authentication"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Internet Download/Online Ordering"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Attachment Manager - Preserve Zone Info"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Root Certificates update"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Windows Explorer - Shell Protocol Protect Mode"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Network - Windows Connect Now Wizards"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Driver Install - Device Driver Search Prompt"
arrCategory(x) = "III"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Power Mgmt - Password Wake When Plugged In"
arrCategory(x) = "II"
...
x = x + 1
arrFinding(x) = "V-15711"
arrKeyPath(x) = "Software\Policies\Microsoft\Windows\Windows Search"
arrSubKey(x) = "AllowIndexingEncryptedStoresOrItems"
arrSubKey2(x) = "X"
arrSubkey3(x) = "X"
arrFile1(x) = "0"
arrFile2(x) = "0"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Search - Encrypted Files Indexing"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V-15712"
arrKeyPath(x) = "Software\Policies\Microsoft\Windows\Windows Search"
arrSubKey(x) = "PreventIndexingUncachedExchangeFolders"
arrSubKey2(x) = "X"
arrSubkey3(x) = "X"
arrFile1(x) = "0"
arrFile2(x) = "0"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Search - Exchange Folder Indexing"
arrCategory(x) = "II"
...
x = x + 1
arrFinding(x) = "V-15724"
arrKeyPath(x) = "Software\Microsoft\Windows\CurrentVersion\Policies\Windows\Sidebar"
arrSubKey(x) = "TurnOffUnsignedGadgets"
arrSubKey2(x) = "X"
arrSubkey3(x) = "X"
arrFile1(x) = "0"
arrFile2(x) = "0"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Gadgets - Unsigned Gadgets"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V-15725"
arrKeyPath(x) = "Software\Microsoft\Windows\CurrentVersion\Policies\Windows\Sidebar"
arrSubKey(x) = "OverrideMoreGadgetsLink"
arrSubKey2(x) = "X"
arrSubkey3(x) = "X"
arrFile1(x) = "0"
arrFile2(x) = "0"
arrFile3(x) = "0"
arrHive(x) = HKLM
arrExpectedValue(x) = "about:blank"
arrExpectedValue2(x) = "0"
arrExpectedValue3(x) = "0"
arrType(x) = "StringEx"
arrTitle(x) = "Gadgets - More Gadgets Link"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V-15726"
arrKeyPath(x) = "Software\Microsoft\Windows\CurrentVersion\Policies\Windows\Sidebar"
arrSubKey(x) = "TurnOffUserInstalledGadgets"
arrSubKey2(x) = "X"
arrSubkey3(x) = "X"
arrFile1(x) = "0"
arrFile2(x) = "0"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Gadgets - User Installed Gadgets"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "UAC - Application Elevations"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Help Experience Improvement Program"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V-16047"
arrKeyPath(x) = "X"
arrSubKey(x) = "X"
arrSubKey2(x) = "X"
arrSubkey3(x) = "X"
...
arrExpectedValue2(x) = "0"
arrExpectedValue3(x) = "0"
arrType(x) = "BuiltinAccount"
arrTitle(x) = "Built-in Admin Account Status"
arrCategory(x) = "II"
...
x = x + 1
arrFinding(x) = "V-17373"
arrKeyPath(x) = "Software\Microsoft\Windows NT\CurrentVersion\Winlogon"
arrSubKey(x) = "AllocateCDRoms"
arrSubKey2(x) = "X"
arrSubkey3(x) = "X"
arrFile1(x) = "0"
arrFile2(x) = "0"
...
arrExpectedValue3(x) = "0"
arrType(x) = "StringEx"
arrTitle(x) = "Secure Removable Media - CD-ROM"
arrCategory(x) = "III"

x = x + 1
arrFinding(x) = "V-17900"
arrKeyPath(x) = "Software\Microsoft\Windows NT\CurrentVersion\IniFileMapping\Autorun.inf"
arrSubKey(x) = ""
arrSubKey2(x) = "X"
arrSubkey3(x) = "X"
arrFile1(x) = "0"
...
arrFile3(x) = "0"
arrHive(x) = HKLM
arrExpectedValue(x) = "@SYS:DoesNotExist"
arrExpectedValue2(x) = "0"
arrExpectedValue3(x) = "0"
arrType(x) = "String"
arrTitle(x) = "Disable AutoPlay/Autorun from Autorun.inf"
arrCategory(x) = "I"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "NTLM Null Session Fallback"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "StringEx"
arrTitle(x) = "Direct Access - Route Through Internal Network"
arrCategory(x) = "III"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Windows Update Point and Printer Driver Search"
arrCategory(x) = "III"
...
x = x + 1
arrFinding(x) = "V-21966"
arrKeyPath(x) = "Software\Policies\Microsoft\Windows\TabletPC"
arrSubKey(x) = "PreventHandwritingDataSharing"
arrSubKey2(x) = "X"
arrSubkey3(x) = "X"
arrFile1(x) = "0"
arrFile2(x) = "0"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Handwriting Personalization Data Sharing"
arrCategory(x) = "III"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ValueEx"
arrTitle(x) = "Anon. enumeration of SAM accounts will not be allowed."
arrCategory(x) = "I"
...
arrFile3(x) = "0"
arrHive(x) = HKLM
arrExpectedValue(x) = "DoD Notice and Consent Banner"
arrExpectedValue2(x) = "0"
arrExpectedValue3(x) = "0"
arrType(x) = "String"
arrTitle(x) = "Legal Banner Dialog Box"
arrCategory(x) = "III"
...
arrExpectedValue3(x) = "0"
arrType(x) = "SecEditRegExp"
arrTitle(x) = "Access this Computer From the Network"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "SecEditRegExp"
arrTitle(x) = "Deny Log On Through RDS"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "SecEditRegExp"
arrTitle(x) = "Force Shutdown from Remote System"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "SecEditRegExp"
arrTitle(x) = "Manage Auditing and Security Log"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "SecEditRegExp"
arrTitle(x) = "Modify and Object Label"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "SecEditRegExp"
arrTitle(x) = "Modify Firmware Environments Values"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "SecEditRegExp"
arrTitle(x) = "Shutdown the System"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "AuditRegExp"
arrTitle(x) = "Audit - Authenticatoin Policy Change - Success"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "AuditRegExp"
arrTitle(x) = "Audit - IPSec Driver - Failure"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "AuditRegExp"
arrTitle(x) = "Audit - Security Systems Extension - Failure"
arrCategory(x) = "II"
...
arrFile3(x) = "0"
arrHive(x) = HKLM
arrExpectedValue(x) = ".*Mismatch.*SeServiceLogonRight.*"
arrExpectedValue2(x) = "0"
arrExpectedValue3(x) = "0"
arrType(x) = "SecEditRegExp"
arrTitle(x) = "Log On as a Service"
arrCategory(x) = "II"
...
arrFile3(x) = "0"
arrHive(x) = HKLM
arrExpectedValue(x) = "Cert\s+Hash\(sha1\)\:\s+c3\s+13\s+f9\s+19\s+a6\s+ed\s+4e\s+0e\s+84\s+51\s+af\s+a9\s+30\s+fb\s+41\s+9a\s+20\s+f1\s+81\s+e4"
arrExpectedValue2(x) = "0"
arrExpectedValue3(x) = "0"
arrType(x) = "DoDCertificates"
...
arrFile3(x) = "0"
arrHive(x) = HKLM
arrExpectedValue(x) = "Cert\s+Hash\(sha1\)\:\s+99\s+c4\s+94\s+ec\s+e4\s+fc\s+09\s+3e\s+ee\s+13\s+c4\s+d6\s+5b\s+1b\s+1e\s+01\s+b9\s+b5\s+d4\s+34"
arrExpectedValue2(x) = "0"
arrExpectedValue3(x) = "0"
arrType(x) = "UntrustedCertificates"
arrTitle(x) = "The DoD Interoperability Root CA 1 to DoD Root CA 2 cross certificate must be installed"
arrCategory(x) = "II"
...
arrExpectedValue3(x) = "0"
arrType(x) = "ManualReview"
arrTitle(x) = "Inbound Firewall Exception for Administration"
arrCategory(x) = "II"
...
WScript.Echo vbCrLf & "Performing " & x & " security checks on Windows 7" & vbCrLf
...
wshShell.run "secedit /analyze /db stig.db /cfg Win7.inf /log stig.txt",,True 
...
For intCount = 0 to x
   ...
   ElseIf(StrComp(arrType(intCount), "PasswordFilter", vbTextCompare)) = 0 Then
      ...
      RegEx.Pattern = ".*EnPasFltv2x86.*"
      RegEx.IgnoreCase = True
      For i = 0 to Ubound(arrMultiReg)
         If RegEx.Test(arrMultiReg(i)) Then
            If objFSO.FileExists("C:\Windows\System32\EnPasFltv2x86.dll") Then
               finding = "closed"
               Exit For
            End If
         End If
   ...
   ElseIf (StrComp(arrType(intCount), "AntiVirus", vbTextCompare)) = 0 Then
      ...
      For Each objService in colServiceList
         If objService.Name = arrExpectedValue(intCount) or objService.Name = arrExpectedValue3(intCount) Then
         ...
         ElseIf objService.Name = arrExpectedValue2(intCount) Then
            objReg.GetStringValue HKLM, "Software\Mcafee\DesktopProtection", "szProductVer", arrValue(intCount)
   ...
   ElseIf(StrComp(arrType(intCount), "TriUntrustedCertificates", vbTextCompare)) = 0 Then
      ...
      Next
      If finding = "open" Then
         strMessage = vbCrLf & "     The Microsoft Online CA001 certificate is not untrusted"
      End If
      If finding = "closed" Then
         finding = "open"
         For i = 0 to UBound(certLines)
            if RegEx2.Test(certLines(i)) Then
               finding = "closed"
            End If
         Next
         If finding = "open" Then
            strMessage = vbCrLf & "     The Microsoft IPTVe CA certificate is not untrusted"
         End If
      End If
      If finding = "closed" Then
         finding = "open"
         For i = 0 to UBound(certLines)
            if RegEx3.Test(certLines(i)) Then
               finding = "closed"
            End If
         Next
         If finding = "open" Then
            strMessage = vbCrLf & "     The Microsoft Genuine Windows Phone Public Preview CA01 certificate is not untrusted"
         End If
      End If
      If finding = "open" Then
         WScript.Echo arrFinding(intCount) & " is Open -- CAT " & arrCategory(intCount) & " -- " & arrTitle(intCount) & strMessage
