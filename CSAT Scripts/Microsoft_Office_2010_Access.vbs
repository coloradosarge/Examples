...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\access\security"
arrKeyPath2(x) = "x"
...
x = x + 1
arrFinding(x) = "DTOO136"
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\access\settings"
arrKeyPath2(x) = "x"
arrSubKey(x) = "Default File Format"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
arrExpectedValue(x) = "12"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Default file format"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "DTOO137"
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\access\settings"
arrKeyPath2(x) = "x"
arrSubKey(x) = "NoConvertDialog"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
arrExpectedValue(x) = "0"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Prompt / Convert Older Databases"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "DTOO135"
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\access\security"
arrKeyPath2(x) = "x"
arrSubKey(x) = "ModalTrustDecisionOnly"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
arrExpectedValue(x) = "0"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Modal Trust Decision Only"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "DTOO130"
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\access\internet"
arrKeyPath2(x) = "x"
arrSubKey(x) = "DoNotUnderlineHyperlinks"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
arrExpectedValue(x) = "0"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Underline hyperlinks"
arrCategory(x) = "II"
...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\common\toolbars\access"
arrKeyPath2(x) = "x"
...
WScript.Echo "Performing " & x & " security checks on Microsoft Office 2010 Access" & vbCrLf
