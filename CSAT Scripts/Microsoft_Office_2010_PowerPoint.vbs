...
arrKeyPath2(x) = "Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_HTTP_USERNAME_PASSWORD_DISABLE"
arrSubKey(x) = "powerpnt.exe"
arrSubKey2(x) = "pptview.exe"
arrHive(x) = HKLM
...
arrKeyPath2(x) = "Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_SAFE_BINDTOOBJECT"
arrSubKey(x) = "powerpnt.exe"
arrSubKey2(x) = "pptview.exe"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
...
arrKeyPath2(x) = "Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_UNC_SAVEDFILECHECK"
arrSubKey(x) = "powerpnt.exe"
arrSubKey2(x) = "pptview.exe"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
...
arrKeyPath2(x) = "Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_VALIDATE_NAVIGATE_URL"
arrSubKey(x) = "powerpnt.exe"
arrSubKey2(x) = "pptview.exe"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
...
arrKeyPath2(x) = "Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_WEBOC_POPUPMANAGEMENT"
arrSubKey(x) = "powerpnt.exe"
arrSubKey2(x) = "pptview.exe"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\powerpoint\security"
arrKeyPath2(x) = "x"
...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\powerpoint\security\fileblock"
arrKeyPath2(x) = "x"
arrSubKey(x) = "PowerPoint12BetaFilesFromConverters"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
arrExpectedValue(x) = "1"
arrExpectedValue2(x) = "x"
...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\powerpoint\security\trusted locations"
arrKeyPath2(x) = "x"
...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\powerpoint\security"
arrKeyPath2(x) = "x"
arrSubKey(x) = "PowerPointBypassEncryptedMacroScan"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\powerpoint\options"
arrKeyPath2(x) = "x"
arrSubKey(x) = "DefaultFormat"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
arrExpectedValue(x) = "27"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
...
x = x + 1
arrFinding(x) = "DTOO290"
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\powerpoint\options"
arrKeyPath2(x) = "x"
arrSubKey(x) = "MarkupOpenSave"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
arrExpectedValue(x) = "1"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Make Hidden marks visible - PowerPoint"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "DTOO289"
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\powerpoint\security"
arrKeyPath2(x) = "x"
arrSubKey(x) = "RunPrograms"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
arrExpectedValue(x) = "0"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Disable Run Programs - PowerPoint"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "DTOO291"
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\powerpoint\security"
arrKeyPath2(x) = "x"
arrSubKey(x) = "DownloadImages"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
arrExpectedValue(x) = "0"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Disable Unblk linked images - PowerPoint"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "DTOO126"
arrKeyPath(x) = "Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_ADDON_MANAGEMENT"
arrKeyPath2(x) = "Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_ADDON_MANAGEMENT"
arrSubKey(x) = "powerpnt.exe"
arrSubKey2(x) = "pptview.exe"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
...
arrKeyPath2(x) = "Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_ZONE_ELEVATION"
arrSubKey(x) = "powerpnt.exe"
arrSubKey2(x) = "pptview.exe"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
...
arrKeyPath2(x) = "Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_RESTRICT_ACTIVEXINSTALL"
arrSubKey(x) = "powerpnt.exe"
arrSubKey2(x) = "pptview.exe"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
...
arrKeyPath2(x) = "Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_RESTRICT_FILEDOWNLOAD"
arrSubKey(x) = "powerpnt.exe"
arrSubKey2(x) = "pptview.exe"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
...
arrKeyPath2(x) = "Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_WINDOW_RESTRICTIONS"
arrSubKey(x) = "powerpnt.exe"
arrSubKey2(x) = "pptview.exe"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\powerpoint\security\filevalidation"
arrKeyPath2(x) = "x"
...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\powerpoint\security\protectedview"
arrKeyPath2(x) = "x"
...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\powerpoint\security\filevalidation"
arrKeyPath2(x) = "Software\Policies\Microsoft\Office\14.0\powerpoint\security\filevalidation"
arrSubKey(x) = "OpenInProtectedView"
...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\common\toolbars\powerpoint"
arrKeyPath2(x) = "x"
...
x = x + 1
arrFinding(x) = "DTOO319"
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\powerpoint\slide libraries"
arrKeyPath2(x) = "x"
arrSubKey(x) = "DisableSlideUpdate"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
arrExpectedValue(x) = "1"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Disable Slide Update"
arrCategory(x) = "II"

WScript.Echo "Performing " & x & " security checks on Microsoft Office 2010 PowerPoint" & vbCrLf
