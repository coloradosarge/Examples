...
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Prevent performance of First Run Customize setting"
arrCategory(x) = "II"
...
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Download unsigned ActiveX - Internet"
arrCategory(x) = "II"
...
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Launching Programs and Files in IFRAME - Internet Zone"
arrCategory(x) = "II"
...
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Content from different domains within windows - Internet Zone"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V34458-DTBI1005"
...
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Content from different domains across windows - Restricted Zone"
arrCategory(x) = "II"
...
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Content from different domains within windows - Restricted Zone"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V34590-DTBI1030"
arrKeyPath(x) = "Software\Policies\Microsoft\Internet Explorer\DomainSuggestion"
arrKeyPath2(x) = "x"
arrSubKey(x) = "Enabled"
arrSubKey2(x) = "x"
arrHive(x) = HKLM
...
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "URL Suggestions Disallowed"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V34456-DTBI1035"
arrKeyPath(x) = "Software\Policies\Microsoft\Internet Explorer\Main"
arrKeyPath2(x) = "x"
arrSubKey(x) = "DisablePasswordReveal"
arrSubKey2(x) = "x"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Displaying of the reveal password button must be disallowed"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V34456-DTBI1040"
arrKeyPath(x) = "Software\Policies\Microsoft\Internet Explorer\Main"
arrKeyPath2(x) = "x"
arrSubKey(x) = "DoNotTrack"
arrSubKey2(x) = "x"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Do Not Track header must be sent"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V34489-DTBI1045"
arrKeyPath(x) = "Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3"
arrKeyPath2(x) = "x"
arrSubKey(x) = "270B"
arrSubKey2(x) = "x"
...
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Legacy Filters Disallowed - Internet Zone"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V34489-DTBI1050"
arrKeyPath(x) = "Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4"
arrKeyPath2(x) = "x"
arrSubKey(x) = "270B"
arrSubKey2(x) = "x"
...
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Legacy Filters Disallowed - Restricted Zone"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V34474-DTBI1055"
arrKeyPath(x) = "Software\Policies\Microsoft\Internet Explorer\Activities"
arrKeyPath2(x) = "x"
arrSubKey(x) = "NoActivities"
arrSubKey2(x) = "x"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Internet Explorer Accelerator Disallowed"
arrCategory(x) = "II"
...
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Internet Explorer must be set to disallow users to add/delete sites"
arrCategory(x) = "II"
...
arrHive(x) = HKLM
arrExpectedValue(x) = "3"
arrExpectedValue2(x) = "4"
arrType(x) = "ValueEx"
arrTitle(x) = "Allow Script Intiated Windows Without Size or Position Contraints - Restricted"
arrCategory(x) = "II"
...
arrExpectedValue2(x) = "x"
arrType(x) = "StringEx"
arrTitle(x) = "Internet Explorer Processes for Zone Elevation (Reserved)"
arrCategory(x) = "II"
...
arrExpectedValue2(x) = "x"
arrType(x) = "StringEx"
arrTitle(x) = "Internet Explorer Processes for Restricting Popups (Explore)"
arrCategory(x) = "II"
...
x = x + 1
arrFinding(x) = "V30774-DTBI745"
arrKeyPath(x) = "Software\Microsoft\Windows\CurrentVersion\Policies\Ext"
arrKeyPath2(x) = "x"
arrSubKey(x) = "DisableAddonLoadTimePerformanceNotifications"
arrSubKey2(x) = "x"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Add-On Performance Notifications"
arrCategory(x) = "II"
...
x = x + 1
arrFinding(x) = "V30775-DTBI755"
arrKeyPath(x) = "Software\Policies\Microsoft\Internet Explorer\Geolocation"
arrKeyPath2(x) = "x"
arrSubKey(x) = "PolicyDisableGeolocation"
arrSubKey2(x) = "x"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Geolocation"
arrCategory(x) = "II"
...
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Launching Programs and Unsafe Files"
arrCategory(x) = "II"
...
x = x + 1
arrFinding(x) = "V34425-DTBI980"
arrKeyPath(x) = "Software\Policies\Microsoft\Internet Explorer\Main"
arrKeyPath2(x) = "x"
arrSubKey(x) = "EnableAutoUpgrade"
arrSubKey2(x) = "x"
arrHive(x) = HKLM
arrExpectedValue(x) = "0"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Internet Explorer Automatic Updates"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V34610-DTBI985"
arrKeyPath(x) = "Software\Policies\Microsoft\Internet Explorer\Main"
arrKeyPath2(x) = "x"
arrSubKey(x) = "DisableEPMCompat"
arrSubKey2(x) = "x"
arrHive(x) = HKLM
arrExpectedValue(x) = "1"
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "ActiveX controls in enhanced protected mode"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V34457-DTBI990"
arrKeyPath(x) = "Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3"
arrKeyPath2(x) = "x"
arrSubKey(x) = "2709"
arrSubKey2(x) = "x"
...
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Content from different domains across windows - Internet Zone"
arrCategory(x) = "II"

x = x + 1
arrFinding(x) = "V34461-DTBI995"
arrKeyPath(x) = "Software\Policies\Microsoft\Internet Explorer\Main"
arrKeyPath2(x) = "x"
arrSubKey(x) = "Isolation"
arrSubKey2(x) = "x"
arrHive(x) = HKLM
arrExpectedValue(x) = "PMEM"
arrExpectedValue2(x) = "x"
arrType(x) = "StringEx"
arrTitle(x) = "Enhanced Protected Mode"
arrCategory(x) = "II"

WScript.Echo "Performing " & x + 1 & " security checks on Internet Explorer 10" & vbCrLf
