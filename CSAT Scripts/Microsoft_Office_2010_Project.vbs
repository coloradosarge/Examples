...
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\ms project\security"
arrKeyPath2(x) = "x"
...
x = x + 1
arrFinding(x) = "DTOO346"
arrKeyPath(x) = "Software\Policies\Microsoft\Office\14.0\ms project\security"
arrKeyPath2(x) = "x"
arrSubKey(x) = "TrustWSS"
arrSubKey2(x) = "x"
arrHive(x) = HKCU
arrExpectedValue(x) = ""
arrExpectedValue2(x) = "x"
arrType(x) = "ValueEx"
arrTitle(x) = "Untrusted intranet zone access"
arrCategory(x) = "II"

WScript.Echo "Performing " & x & " security checks on Internet Explorer 8" & vbCrLf
